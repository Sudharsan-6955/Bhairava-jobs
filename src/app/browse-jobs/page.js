		...
		<div className="bg-white min-h-screen">
			...
			<div className="bg-white pt-36 pb-16 px-4 md:px-8">
				<div className="max-w-3xl mx-auto text-center">
					...
					<h1 className="text-4xl md:text-6xl font-bold text-[#232B3E] mb-2">
								...
								{paginatedJobs.map((job, index) => (
									...
									>
										...
										<h3 className="text-sm font-bold text-[#232B3E] mb-2 break-words">
											...
											<div className="flex  sm:flex-row items-start sm:items-center justify-start gap-1.5 sm:gap-2 pt-2 border-t border-gray-300 mt-auto">
												<span className="bg-white text-xs text-gray-600 font-medium px-3 py-1.5 md:py-1.5 py-2  rounded-full shadow-md border border-gray-100 whitespace-nowrap">
												...
												>
														<Image
															src="/images/Browsejobs/whatsapp.svg"
															alt="WhatsApp"
															width={14}
															height={14}
															className="shrink-0"
